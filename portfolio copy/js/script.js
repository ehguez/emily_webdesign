$(document).ready(function(){
    ...
    $(document).ready(function() {
     ...
     $('#moreCodeColor').css("fill", colors[rand]);
     $('#pixelByPixelColor').css("fill", colors[rand]);
     $('#scannerColor').css("fill", colors[rand]);
     $('em').css("color", colors[rand]);
   ...
   $('#pixelByPixelButton').click(function(){
        $('.pixelBox').toggle();
    });

   $('#scannerPortraitsButton').click(function(){
        $('.scannerBox').toggle();
    });
